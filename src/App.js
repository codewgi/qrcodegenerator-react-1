    ...
    <div className="w-full min-h-screen grid place-content-center bg-[#181818]">
        <div className='w-[23rem] p-7 space-y-8 text-slate-300'>
            ...
            <form className='space-y-5' onSubmit={handler}>
              <div>
                <input className='bg-[#252525] rounded w-full p-2 focus:outline outline-neutral-300' placeholder='text or yourlink.com' id='input-text'></input>
              </div>
              <button className='w-full py-3 flex justify-center bg-[#252525] hover:bg-neutral-600 duration-200 rounded'>Create</button>
            </form>
        </div>
    </div>
  );
